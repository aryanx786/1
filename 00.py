...
def logo():
    print("\033[1;31m--------------------------------------------------------")
    print("\033[1;31mTOOL BY ARYAN X DORAEMON ON FIRE")
    print("\033[1;31m--------------------------------------------------------")
    print("\033[1;31m==================================================")
    print("\033[1;35mLOWDE  SUN TOOL FULL NONSTOP HX")
    print("\033[1;31m==================================================")
    print("\033[1;34mBS APNA DATA OFF MT KARNA JA NETISSUE MT HONE DENA")
    print("\033[1;31m===================================================")
    print("\033[1;33mDORAEMON KA TOOL HX GAND FADU HI HOGA")
    print("\033[1;31m====================================================")
...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/aryanx786/APL/blob/main/APL.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
